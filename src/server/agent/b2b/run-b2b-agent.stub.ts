 ...
 * Stub do Agent (B2B).
 *
 * Objetivo: provar o encadeamento receiver → dispatcher → agent → tools (auditáveis),
 * sem depender do runtime real (OpenAI Agent Kit).
 */
export async function runB2BAgentStub(params: {
